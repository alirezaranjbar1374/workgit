      ...
      <div className="footer-content">
        <div className="footer-content-column">
          ...
          <div className="footer-menu">
            <h2 className="footer-menu-name"> سوالات متداول</h2>
            <ul id="menu-get-started" className="footer-menu-list">
              <li className="menu-item menu-item-type-post_type menu-item-object-product">
                <a href="#">اخبار</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-product">
                <a href="#">مشاوره آنلاین/نقشه راه</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-product">
                <a href="#">انجام پروژه</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="footer-content-column">
          <div className="footer-menu">
            ...
            <Link to='/countentus'>همکاری با ما</Link>
               </h2>
            <ul id="menu-company" className="footer-menu-list">
              ...
              <h2 className="footer-menu-name">
              <Link to='/countentus'>رفع اشکال آنلاین</Link>
              </h2>
          ...
          <div className="footer-menu">
            ...
            <Link to='/countentus'> کلاس های حضوری</Link>
            ...
            <Link to='/countentus'> کلاس های آنلاین</Link>
           ...
           <Link to='/countentus'>درخواست تشکیل کلاس</Link>
        ...
        <div className="footer-content-column">
          <div className="footer-call-to-action">
            ...
            <Link to='/about'>درباره ما</Link>
                      ...
                      <h2 className="footer-call-to-action-description"> 
                      <Link to='/countentus'>آدرس</Link>
                      </h2>

            <a className="footer-call-to-action-button button" href="https://wa.me/09399123908/?text=slm" target="_self">پشتیبانی واتساپ</a>
          </div>
          <div className="footer-call-to-action">
            <h2 className="footer-call-to-action-title"> شماره پشتیبانی</h2>
            <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="02155645491" target="_self">02155645491 </a></p>
          </div>
        </div>
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="#" target="_self"> کلیه حقوق مادی ومعنوی سایت مطلق به اندیش لرن است 2022 </a>
          </p>
        </div>
      </div>
    </footer>
